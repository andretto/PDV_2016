        ...
        switch (requestCode) {
            case IntentIntegrator.REQUEST_CODE:
                ...
                if (result != null) {
                    ...
                    Produto produto = Query.one(Produto.class,"select * from produto codigo_barra =?",result).get();
                    if (produto !=null){
                        ...
                        Toast.makeText(MainActivity.this, "Produto nao localizado", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
            default:
